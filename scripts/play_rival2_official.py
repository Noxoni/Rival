"""Launch a standard offline human-vs-Rival-Official RLBot v5 match."""
...
RIVAL_CONFIG = ROOT / "bot/rival2_official/rival2.bot.toml"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Play a five-minute 1v1 against Rival")
