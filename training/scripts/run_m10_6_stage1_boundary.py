"""Run one recoverable Stage-1 V5 training boundary."""
...
def main() -> int:
    ...
    base.DEFAULT_CHECKPOINT_ROOT = REPOSITORY_ROOT / "training/checkpoints/milestone10_6/stage_1"
    base.STAGE_MAXIMUM_ACTIVE_STEPS = 2_160_000
    base.SOURCE_STATE_KEY = "v10_6_source_checkpoint"
    base.ACTIVE_BOUNDARY_STATE_KEY = "v10_6_active_boundary_hours"
    base.COMPLETED_BOUNDARY_STATE_KEY = "v10_6_completed_boundary_hours"
    base.TRAINING_BOUNDARY_VERSION = "RivalM10_6Stage1TrainingBoundaryV1"
    return base.main()
