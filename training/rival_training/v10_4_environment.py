"""Stage-1-only RocketSim environment with the V3 acquisition reward."""
...
from .v10_4_reward import RivalBallAcquisitionRewardV3
from .v9_environment import RivalObsV1RLGymBuilder
from .v9_symmetry import RivalEpisodeSymmetryActionParser


BALL_ACQUISITION_ENVIRONMENT_VERSION = "RivalBallAcquisitionEnvV3"


class RivalSingleLearnerGymWrapperV3(RivalSingleLearnerGymWrapperV1):
    """V3 marker around the unchanged learner/dummy isolation wrapper."""
...
def build_ball_acquisition_env(
    *,
    ...
    return RLGym(
        ...
        reward_fn=RivalBallAcquisitionRewardV3(),
...
def make_ball_acquisition_phase_a_env() -> RivalSingleLearnerGymWrapperV3:
    return RivalSingleLearnerGymWrapperV3(
        build_ball_acquisition_env(phase="A", seed=20261041 + _worker_offset())
    )


def make_ball_acquisition_phase_b_env() -> RivalSingleLearnerGymWrapperV3:
    return RivalSingleLearnerGymWrapperV3(
        build_ball_acquisition_env(phase="B", seed=20261041 + _worker_offset())
    )
