"""Stage-1-only RocketSim environment for the uncapped reacquisition experiment."""
...
from .v10_6_reward import RivalBallAcquisitionRewardV5
from .v9_environment import RivalObsV1RLGymBuilder
from .v9_symmetry import RivalEpisodeSymmetryActionParser


BALL_ACQUISITION_ENVIRONMENT_VERSION = "RivalBallAcquisitionEnvV5"


class RivalSingleLearnerGymWrapperV5(RivalSingleLearnerGymWrapperV1):
    """V5 marker around the unchanged learner/dummy isolation wrapper."""
...
def build_ball_acquisition_env(
    *,
    ...
    return RLGym(
        ...
        reward_fn=RivalBallAcquisitionRewardV5(),
...
def make_ball_acquisition_phase_a_env() -> RivalSingleLearnerGymWrapperV5:
    return RivalSingleLearnerGymWrapperV5(
        build_ball_acquisition_env(phase="A", seed=20261061 + _worker_offset())
    )


def make_ball_acquisition_phase_b_env() -> RivalSingleLearnerGymWrapperV5:
    return RivalSingleLearnerGymWrapperV5(
        build_ball_acquisition_env(phase="B", seed=20261061 + _worker_offset())
    )
