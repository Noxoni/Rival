"""Deterministic Stage-1 V4 evaluation with heading and idle telemetry."""
...
from .v10_5_campaign import REPOSITORY_ROOT
from .v10_5_environment import (
    ...
    *,
    ...
    report["checks"]["passed"] = all(
        (
            ...
            report["checks"]["heading_telemetry_present"],
            report["checks"]["idle_telemetry_present"],
