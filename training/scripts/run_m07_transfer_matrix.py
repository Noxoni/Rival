...
def _mode_definitions() -> dict[str, dict[str, Any]]:
...
def main() -> int:
    ...
    report = (
        ...
        if args.resume and args.output.is_file()
            ...
            "schema_version": 1,
            "status": "in_progress",
            "evaluation": "milestone07_bounded_rlbot_transfer_matrix",
            ...
            for index in range(len(entry["games"]), len(desired_schedule)):
                ...
                try:
                    manifest = run_natural_match(
                        ...
                        game_speed=5.0,
                        challenge_mode="off",
                        lane_id="m07-transfer-diagnostic",
                        execution_regime="sequential_fresh_process_per_game",
                        session_version="v7",
                        session_source="milestone07_transfer_matrix",
                        experiment_milestone="m07-transfer-diagnosis",
                        experiment_metadata={
                            "mode": mode,
