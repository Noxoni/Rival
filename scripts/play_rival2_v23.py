"""Launch a standard offline human-vs-Rival-V23 RLBot v5 match."""
...
RIVAL2_CONFIG = ROOT / "bot" / "rival2_v23" / "rival2.bot.toml"
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Play a standard five-minute offline 1v1 against Rival 2 V23"
    )
    ...
    try:
        ...
        print(
            "Rival V23 match started: "
            f"human={'Blue' if human_team == 0 else 'Orange'}, "
            f"Rival V23={'Orange' if human_team == 0 else 'Blue'}"
        )
        while True:
