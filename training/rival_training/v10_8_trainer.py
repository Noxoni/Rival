"""M10.8 trainer: M10.7 PPO plus read-only credit-window diagnostics."""
...
from .v10_8_credit import credit_assignment_window_diagnostics
from .v9_policy import RivalCriticV1
from .v9_trainer import RivalV9PPOTrainer


class RivalV10_8PPOTrainer(RivalV9PPOTrainer):
    """Keep PPO frozen while observing physical-time reward credit."""
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            credit_assignment_diagnostics_fn=credit_assignment_window_diagnostics,
        )
