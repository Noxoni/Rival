"""One-trainable-learner RocketSim environment for Rival v10.3 Stage 1 V2."""
...
from .v10_3_reward import RivalBallAcquisitionRewardV2
from .v9_environment import RivalObsV1RLGymBuilder
from .v9_symmetry import RivalEpisodeSymmetryActionParser


BALL_ACQUISITION_ENVIRONMENT_VERSION = "RivalBallAcquisitionEnvV2"


class RivalSingleLearnerGymWrapperV2(RivalSingleLearnerGymWrapperV1):
    """V2 marker around the unchanged one-row learner/dummy isolation wrapper."""
...
def build_ball_acquisition_env(
    *,
    ...
    return RLGym(
        ...
        reward_fn=RivalBallAcquisitionRewardV2(),
...
def make_ball_acquisition_phase_a_env() -> RivalSingleLearnerGymWrapperV2:
    return RivalSingleLearnerGymWrapperV2(
        build_ball_acquisition_env(
            phase="A",
            seed=20261031 + _worker_offset(),
        )
    )


def make_ball_acquisition_phase_b_env() -> RivalSingleLearnerGymWrapperV2:
    return RivalSingleLearnerGymWrapperV2(
        build_ball_acquisition_env(
            phase="B",
            seed=20261031 + _worker_offset(),
