"""Run one recoverable Rival v10.3 Stage-1 V2 training boundary."""
...
def main() -> int:
    ...
    base.boundary_ppo_batch_agent_steps = (
        campaign.boundary_ppo_batch_agent_steps
    )
    ...
    base.BALL_ACQUISITION_ENV_FACTORY_BY_PHASE = (
        BALL_ACQUISITION_ENV_FACTORY_BY_PHASE
    )
    base.DEFAULT_CHECKPOINT_ROOT = (
        REPOSITORY_ROOT / "training/checkpoints/milestone10_3/stage_1"
    )
    base.SOURCE_STATE_KEY = "v10_3_source_checkpoint"
    base.ACTIVE_BOUNDARY_STATE_KEY = "v10_3_active_boundary_hours"
    base.COMPLETED_BOUNDARY_STATE_KEY = "v10_3_completed_boundary_hours"
    base.TRAINING_BOUNDARY_VERSION = (
        "RivalM10_3Stage1TrainingBoundaryV1"
    )
    return base.main()
