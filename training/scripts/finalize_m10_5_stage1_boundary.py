"""Evaluate and decide one Stage-1 V4 boundary."""
...
def main() -> int:
    ...
    base.BOUNDARY_RESULT_VERSION = "RivalM10_5Stage1BoundaryResultV1"
    base.STAGE1_SUCCESS_DECISION = "unused_stage1_success_decision"
    base.STAGE1_SUCCESS_NEXT_STAGE = None
    base.STAGE1_TERMINAL_BOUNDARY_HOURS = 5.0
    base.STAGE1_TERMINAL_DECISION = campaign.TERMINAL_DECISION
    return base.main()
